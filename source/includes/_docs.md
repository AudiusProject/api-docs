...
## get_app_name_list_metrics

<a id="opIdget_app_name_list_metrics"></a>

> Code Sample

```shell
curl AUDIUS_API_HOST/v1/metrics/app_name?limit=0?offset=0 
 

```

```http
GET AUDIUS_API_HOST/v1/metrics/app_name?limit=0?offset=0 HTTP/1.1
...
fetch('AUDIUS_API_HOST/v1/metrics/app_name?limit=0?offset=0',
{
  method: 'GET',
...
result = RestClient.get 'AUDIUS_API_HOST/v1/metrics/app_name?limit=0?offset=0',
  params: {
  }, headers: headers
...
r = requests.get('AUDIUS_API_HOST/v1/metrics/app_name?limit=0?offset=0', headers = headers)
...
try {
    $response = $client->request('GET','AUDIUS_API_HOST/v1/metrics/app_name?limit=0?offset=0', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("AUDIUS_API_HOST/v1/metrics/app_name?limit=0?offset=0");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "AUDIUS_API_HOST/v1/metrics/app_name?limit=0?offset=0", data)
    req.Header = headers
...
`GET /metrics/app_name`

*List all the app names*

<h3 id="get_app_name_list_metrics-parameters">Query Parameters</h3>

|Name|Type|Required|Description|
|---|---|---|---|---|
|limit|integer|false|none|
|offset|integer|false|none|
...
<h3 id="get_app_name_list_metrics-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Success|[app_name_response](#schemaapp_name_response)|

## get_app_name_metrics

<a id="opIdget_app_name_metrics"></a>

> Code Sample

```shell
curl AUDIUS_API_HOST/v1/metrics/app_name/string?start_time=0?limit=0 
 

```

```http
GET AUDIUS_API_HOST/v1/metrics/app_name/string?start_time=0?limit=0 HTTP/1.1
...
fetch('AUDIUS_API_HOST/v1/metrics/app_name/string?start_time=0?limit=0',
{
  method: 'GET',
...
result = RestClient.get 'AUDIUS_API_HOST/v1/metrics/app_name/string?limit=0',
  params: {
  'start_time' => 'integer'
}, headers: headers
...
r = requests.get('AUDIUS_API_HOST/v1/metrics/app_name/string?limit=0', params={
  'start_time': '0'
}, headers = headers)
...
try {
    $response = $client->request('GET','AUDIUS_API_HOST/v1/metrics/app_name/string?limit=0', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("AUDIUS_API_HOST/v1/metrics/app_name/string?start_time=0?limit=0");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "AUDIUS_API_HOST/v1/metrics/app_name/string?limit=0", data)
    req.Header = headers
...
`GET /metrics/app_name/{app_name}`

*Get the app name metrics*

<h3 id="get_app_name_metrics-parameters">Query Parameters</h3>

|Name|Type|Required|Description|
|---|---|---|---|---|
|start_time|integer|true|none|
|limit|integer|false|none|
|app_name|string|true|none|
...
<h3 id="get_app_name_metrics-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Success|[app_name_metrics_response](#schemaapp_name_metrics_response)|

## get_route_metrics

<a id="opIdget_route_metrics"></a>

> Code Sample

```shell
curl AUDIUS_API_HOST/v1/metrics/routes?path=string?query_string=string?start_time=0?limit=0?version=string 
 

```

```http
GET AUDIUS_API_HOST/v1/metrics/routes?path=string?query_string=string?start_time=0?limit=0?version=string HTTP/1.1
...
fetch('AUDIUS_API_HOST/v1/metrics/routes?path=string?query_string=string?start_time=0?limit=0?version=string',
{
  method: 'GET',
...
result = RestClient.get 'AUDIUS_API_HOST/v1/metrics/routes?path=string?query_string=string?start_time=0?limit=0?version=string',
  params: {
  'path' => 'string',
'start_time' => 'integer'
}, headers: headers
...
r = requests.get('AUDIUS_API_HOST/v1/metrics/routes?path=string?query_string=string?start_time=0?limit=0?version=string', params={
  'path': 'string',  'start_time': '0'
}, headers = headers)
...
try {
    $response = $client->request('GET','AUDIUS_API_HOST/v1/metrics/routes?path=string?query_string=string?start_time=0?limit=0?version=string', array(
        'headers' => $headers,
        'json' => $request_body,
       )
    );
...
```java
URL obj = new URL("AUDIUS_API_HOST/v1/metrics/routes?path=string?query_string=string?start_time=0?limit=0?version=string");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "AUDIUS_API_HOST/v1/metrics/routes?path=string?query_string=string?start_time=0?limit=0?version=string", data)
    req.Header = headers
...
<h3 id="get_route_metrics-parameters">Query Parameters</h3>

|Name|Type|Required|Description|
|---|---|---|---|---|
|path|string|true|none|
|query_string|string|false|none|
|start_time|integer|true|none|
|limit|integer|false|none|
|version|array[string]|false|none|
...
<h3 id="get_route_metrics-responses">Responses</h3>

|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Success|[metrics_reponse](#schemametrics_reponse)|
...
<a id="schemametrics_reponse"></a>
<a id="schema_metrics_reponse"></a>
<a id="tocSmetrics_reponse"></a>
<a id="tocsmetrics_reponse"></a>
<h2 id="tocS_metrics_reponse">metrics_reponse</h2>
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|data|[[route_metric](#schemaroute_metric)]|false|none|none|

<a id="schemaroute_metric"></a>
<a id="schema_route_metric"></a>
<a id="tocSroute_metric"></a>
<a id="tocsroute_metric"></a>
<h2 id="tocS_route_metric">route_metric</h2>
...
<a id="schemaapp_name_response"></a>
<a id="schema_app_name_response"></a>
<a id="tocSapp_name_response"></a>
<a id="tocsapp_name_response"></a>
<h2 id="tocS_app_name_response">app_name_response</h2>
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|data|[[app_name](#schemaapp_name)]|false|none|none|

<a id="schemaapp_name"></a>
<a id="schema_app_name"></a>
<a id="tocSapp_name"></a>
<a id="tocsapp_name"></a>
<h2 id="tocS_app_name">app_name</h2>
...
<a id="schemaapp_name_metrics_response"></a>
<a id="schema_app_name_metrics_response"></a>
<a id="tocSapp_name_metrics_response"></a>
<a id="tocsapp_name_metrics_response"></a>
<h2 id="tocS_app_name_metrics_response">app_name_metrics_response</h2>
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|data|[[app_name_metric](#schemaapp_name_metric)]|false|none|none|

<a id="schemaapp_name_metric"></a>
<a id="schema_app_name_metric"></a>
<a id="tocSapp_name_metric"></a>
<a id="tocsapp_name_metric"></a>
<h2 id="tocS_app_name_metric">app_name_metric</h2>
